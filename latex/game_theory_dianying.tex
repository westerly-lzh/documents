...
\textbf{西南交通大学研究生考试}\par % Book title
\vspace*{3cm}
{\huge 
	\textbf{
...
\begin{flushleft}
	\textbf{\hspace{2cm}课程名称：\underline{\hspace{1cm}博弈论\hspace{3.8cm}}}
	\vspace{0.5cm}

	\textbf{\hspace{2cm}院\hspace{0.85cm}(系)：\underline{\hspace{1cm}经济管理学院\hspace{1.5cm}}}	
	\vspace{0.5cm}
	
	\textbf{\hspace{2cm}专\hspace{1.6cm}业：\underline{\hspace{1cm}工程管理\hspace{3cm}}}
	\vspace{0.5cm}
	
	\textbf{\hspace{2cm}年\hspace{1.6cm}级：\underline{\hspace{1cm}2014级\hspace{3.7cm}}}
	\vspace{0.5cm}
...
\bibliography{game_theory_dianying.bib}
